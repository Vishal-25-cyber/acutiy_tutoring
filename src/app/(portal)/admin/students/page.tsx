  ...
  return (
    <main className="p-6 sm:p-8 space-y-6 max-w-7xl animate-in fade-in duration-150">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h2 className="text-2xl font-extrabold tracking-tight">Student Directory & Management</h2>
              <p className="text-xs text-slate-500 mt-1">
                Filter, edit batch assignments, inspect attendance risk levels, and reset student accounts.
              </p>
            </div>
            <Button variant="primary" size="md" className="gap-2 font-bold" onClick={() => setIsAddModal(true)}>
